...
следующая сессия прочитает там код до мержа. Ненулевой код выхода с сообщением, что ветку
удалить не удалось — локальную или на `origin`, — не провал уборки: дерево уже удалено,
повторять цель неоткуда, а оставшуюся ветку и команду из вывода назови в отчёте. Сообщение
про само дерево — наоборот, провал: уборка встала на его удалении, и вывод говорит, повторить
ли цель из дерева задачи или доделывать уборку названными командами.
