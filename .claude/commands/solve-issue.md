...
повторять цель неоткуда, а оставшуюся ветку и подсказку из вывода назови в отчёте. Сообщение
про само дерево — наоборот, провал: уборка встала на его удалении, и подсказка говорит,
повторить ли цель из дерева задачи или доделывать уборку названными в ней командами.
