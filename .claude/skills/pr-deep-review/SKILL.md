...
**Источник истины — раздел «Инварианты» в `docs/architecture.md`** и раздел «Стиль»
в `CLAUDE.md`. Не воспроизводи инварианты по памяти: прочитай раздел целиком. Если диф
трогает логгер, конфиг, ошибки или пайплайн middleware — дочитай раздел затронутой
подсистемы там же целиком, вместе с её последовательностью. Пройди по каждому инварианту,
который реально задет дифом, и отметь только их.
