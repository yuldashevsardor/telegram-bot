...
инвариантов и не воспроизводи их по памяти: перечитай в нём разделы «Инварианты» и «Стиль».
Если диф трогает логгер, конфиг, ошибки или пайплайн middleware — дочитай раздел
«Инварианты» и раздел затронутой подсистемы в `docs/architecture.md` и соответствующий
поток в `docs/flows.md`. Пройди по каждому инварианту, который реально задет дифом, и
отметь только их.
