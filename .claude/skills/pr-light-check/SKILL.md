...
(`docs/architecture/testing.md`, «Запись прогона»): файл из одних типов виден в записи только
...
в дифе читаются вместе с причиной. Список выживших в записи оборван строкой «и ещё N» — запись не
