...
Снести дерево может не выйти — например, оно заблокировано `git worktree lock`. На этом шаге
цель и останавливается: при живом дереве удаление его ветки и подтягивание `main` обещали бы
убранное. В выводе сказано, что приложение вместе с образом и томом уже погашено и что цель
нужно повторить из того же дерева, устранив причину, — каталог дерева на месте, а повторное
гашение уже погашенного приложения ничего не портит.
