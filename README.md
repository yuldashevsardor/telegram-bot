...
там уже не было». Цель договаривает вывод, называет команду для ручного удаления
оставшейся ветки из основного дерева и завершается ненулевым кодом: им эти исходы и
