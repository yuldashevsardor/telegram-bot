...
дерево не на `main`, `fetch` не дошёл до origin или ff-мерж отказал (свои коммиты в `main`,
незакоммиченные правки в тех же файлах) — цель говорит, что `main` не подтянут, и называет
команду. Уборка дерева при этом уже сделана,
