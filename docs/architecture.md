...
- `npm test` (цель `make test`) — `mocha`; параметры прогона живут в `.mocharc.json`, а не в аргументах скрипта (см. §14).
