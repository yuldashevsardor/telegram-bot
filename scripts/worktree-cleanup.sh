...
Слот пула токенов за деревом занят, пока цел его каталог и не истёк BOT_TOKEN_TTL
(по умолчанию 2 часа) с последнего продления; успешный повтор снимает слот сразу."
    fi
...
"
        ...
        slot="
Слот пула токенов за деревом занят, пока цел его каталог и не истёк BOT_TOKEN_TTL
(по умолчанию 2 часа) с последнего продления; снимает слот сразу первая строка рецепта."
    fi
