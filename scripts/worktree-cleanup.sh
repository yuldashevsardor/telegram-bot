...
# то самое устаревание, от которого стоит fetch ниже. cd — по той же причине, что в
# подсказке про ветку на origin выше: каталог, из которого запускали цель, уже снесён.
