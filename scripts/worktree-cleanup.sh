...
# ветку и ветку на origin, а напоследок обновляет origin/main и подтягивает main в
# основном дереве.
#
...
# читается наравне с работающей задачей. Пятое и шестое действия, обновление origin/main
# и подтягивание main, мусора за собой не оставляют и стоят здесь по своим причинам — они
# у них в комментариях.
set -eu
...
# проходит сама на следующей уборке, а вот `.lock`, оставшийся от убитого посреди фетча git,
