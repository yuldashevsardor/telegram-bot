...
# его создают цели make, — см. комментарий у DC_APP в Makefile. Права как у .env: файл перекрывает
# любую переменную окружения, включая BOT_TOKEN, значит хранит те же секреты. Читать его в
