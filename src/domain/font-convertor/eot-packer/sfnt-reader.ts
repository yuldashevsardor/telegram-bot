...
// в конверт EOT кладётся один шрифт, а какой из коллекции, сказать нечем. До кодека она
// и не доходит: коллекцию отсекает сигнатура на входе (`FontSignatureMatcher`), а здесь
// проверка остаётся для распаковки — в конверте коллекции быть не должно.
