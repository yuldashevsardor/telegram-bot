...
export class FontForge {
    ...
    // EotPacker takes the envelope off and puts it on, so the engine reads and writes only a plain
    // sfnt (issue https://github.com/yuldashevsardor/telegram-bot/issues/158).
