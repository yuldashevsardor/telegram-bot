...
describe("InvalidEot and UnsupportedEotFlags", function () {
    ...
    // из проверок отвергла вход, не требование (docs/architecture/testing.md, "Working through
    // survivors"). Шестнадцатеричные значения взяты с ведущими нулями: поле печатается во всю
    // ширину.
    const cases = [
        {
